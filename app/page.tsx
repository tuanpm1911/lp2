...
export default function Home(){
  ...
  async function generate(){
    ...
    try{
      ...
      setSpec(nextSpec);
      setData(pageSpecToPuck(nextSpec));
      setEditorKey(k=>k+1);
  ...
  return <>
    <header className="topbar"><div className="brand">RUN <span>LP Studio</span></div><div className="badge">V1 · Structured Page Builder</div></header>
    <main className="workspace">
      ...
      <section className="canvas">
        ...
        <div className="editor-wrap">
          ...
          <div className="specbar"><button className="secondary" onClick={()=>data&&saveDraft(data)}>Lưu draft</button><button className="secondary" onClick={exportJson}>Export JSON</button></div>
        </div>}
      </section>
    </main>
  </>;
